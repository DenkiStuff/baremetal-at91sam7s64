...
# -c    : compile only
# -g    : source level debugging
CCFLAGS = -c -mcpu=$(ARM_CPU) -mthumb-interwork -O2 -mlong-calls -ffunction-sections -Wall -DNDBEBUG -o$@
...
$(BINDIR)/$(APP_NAME).elf : ./$(APP_NAME).ld $(BINDIR)/startup.o $(BINDIR)/arm_exc.o $(BINDIR)/low_level_init.o $(BINDIR)/bsp.o $(BINDIR)/isr.o $(BINDIR)/blinky.o
	$(LINK) $(BINDIR)/startup.o $(BINDIR)/arm_exc.o $(BINDIR)/low_level_init.o $(BINDIR)/bsp.o $(BINDIR)/isr.o $(BINDIR)/blinky.o $(LINKFLAGS)
